...
- Bump backend version to v21.0.1
- Move development dependencies from requirements files to pyproject metadata.
- Configure Black's supported Python targets and isolate Tutor test output.
